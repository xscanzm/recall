      ...
      <main id="top">
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow"><span /> Windows 公开测试版 · 0.4.1</p>
        ...
        <section className="before-section" id="before">
          ...
          <div className="before-list">
            <p><span>01</span><b>目前支持 Windows x64</b><small>安装包约 92 MB，版本 0.4.1。</small></p>
        ...
        <section className="final-cta">
          ...
          <small>Windows x64 · v0.4.1 · 自带 API Key</small>
        </section>
      </main>
