-- 028_fts5_trigram.sql
-- Rebuild memory_search_fts using FTS5 trigram tokenizer for Chinese substring matching.
...
DROP TRIGGER IF EXISTS memory_search_facts_ai;
DROP TRIGGER IF EXISTS memory_search_facts_au;
DROP TRIGGER IF EXISTS memory_search_facts_ad;
...
DROP TRIGGER IF EXISTS memory_search_scenes_ai;
DROP TRIGGER IF EXISTS memory_search_scenes_au;
DROP TRIGGER IF EXISTS memory_search_scenes_ad;
...
DROP TRIGGER IF EXISTS memory_search_tasks_ai;
DROP TRIGGER IF EXISTS memory_search_tasks_au;
DROP TRIGGER IF EXISTS memory_search_tasks_ad;
...
DROP TRIGGER IF EXISTS memory_search_projects_ai;
DROP TRIGGER IF EXISTS memory_search_projects_au;
DROP TRIGGER IF EXISTS memory_search_projects_ad;
...
DROP TRIGGER IF EXISTS memory_search_decisions_ai;
DROP TRIGGER IF EXISTS memory_search_decisions_au;
DROP TRIGGER IF EXISTS memory_search_decisions_ad;
...
DROP TRIGGER IF EXISTS memory_search_people_ai;
DROP TRIGGER IF EXISTS memory_search_people_au;
DROP TRIGGER IF EXISTS memory_search_people_ad;
...
DROP TRIGGER IF EXISTS memory_search_reports_ai;
DROP TRIGGER IF EXISTS memory_search_reports_au;
DROP TRIGGER IF EXISTS memory_search_reports_ad;
